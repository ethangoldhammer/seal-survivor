// Builds tools/looks/vital-arcs.html into a scratch directory so it can be served
...
//
//   npx vite build --config tools/looks/vite.arcs.config.mjs --outDir <dir>
...
export default defineConfig({
  ...
  build: {
    ...
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-arcs-look'),
    emptyOutDir: true,
    rollupOptions: { input: [resolve(HERE, 'vital-arcs.html')] },
  },
});
