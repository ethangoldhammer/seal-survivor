// Builds tools/looks/yacht-deck.html into a scratch directory so it can be
...
//
// `outDir` is overridden on the command line in practice:
//   npx vite build --config tools/looks/vite.yacht.config.mjs --outDir <dir>
...
export default defineConfig({
  ...
  build: {
    ...
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-yacht-look'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'yacht-deck.html') },
  },
});
