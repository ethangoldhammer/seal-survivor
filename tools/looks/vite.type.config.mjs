// Builds tools/looks/type-specimen.html into a scratch directory so it can be served
...
//
//   npx vite build --config tools/looks/vite.skins.config.mjs --outDir <dir>
...
export default defineConfig({
  ...
  build: {
    ...
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-type-look'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'type-specimen.html') },
  },
});
