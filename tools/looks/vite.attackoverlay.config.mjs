// Builds tools/looks/attack-overlay.html into a scratch directory so it can be served
...
//
//   npx vite build --config tools/looks/vite.attackoverlay.config.mjs --outDir <dir>
...
export default defineConfig({
  ...
  build: {
    ...
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-attack-look'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'attack-overlay.html') },
  },
});
