// Builds tools/looks/gore.html into a scratch directory so it can be served
...
//
//   npx vite build --config tools/looks/vite.gore.config.mjs --outDir <dir>
...
export default defineConfig({
  ...
  build: {
    ...
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-gore-look'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'gore.html') },
  },
});
