// Builds tools/looks/graves.html into a scratch directory so it can be served
...
export default defineConfig({
  ...
  build: {
    ...
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-graves-look'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'graves.html') },
  },
});
