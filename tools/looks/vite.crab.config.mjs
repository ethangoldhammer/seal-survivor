// Builds tools/looks/crab-reach.html into a scratch directory so it can be served
...
export default defineConfig({
  ...
  build: {
    ...
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-crab-look'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'crab-reach.html') },
  },
});
