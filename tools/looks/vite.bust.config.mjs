// Builds tools/looks/splash-bust.html into a scratch directory so it can be
...
//
//   npx vite build --config tools/looks/vite.bust.config.mjs --outDir dist-bust-look
...
export default defineConfig({
  ...
  build: {
    ...
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-bust-look'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'splash-bust.html') },
  },
});
