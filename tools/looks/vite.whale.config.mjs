// Builds tools/looks/whale-sweep.html into a scratch directory so it can be served
...
//
//   npx vite build --config tools/looks/vite.crab.config.mjs --outDir <dir>
...
export default defineConfig({
  ...
  build: {
    ...
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-whale-look'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'whale-sweep.html') },
  },
});
