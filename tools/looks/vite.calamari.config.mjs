// Builds tools/looks/calamari.html into a scratch directory so it can be
...
export default defineConfig({
  ...
  build: {
    ...
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-calamari-look'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'calamari.html') },
  },
});
