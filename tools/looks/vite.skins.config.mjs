// Builds tools/looks/skins.html into a scratch directory so it can be served
...
export default defineConfig({
  ...
  build: {
    ...
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-skins-look'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'skins.html') },
  },
});
