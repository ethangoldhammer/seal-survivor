// Builds tools/looks/ball-lab.html into a scratch directory so it can be served
...
export default defineConfig({
  ...
  base: './',
  build: {
    // The page awaits its preset at the top level.
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-ball-lab'),
    emptyOutDir: true,
    rollupOptions: {
      input: resolve(HERE, 'ball-lab.html'),
    },
  },
});
