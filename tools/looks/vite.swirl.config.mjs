// Builds tools/looks/sardine-swirl.html into a scratch directory so it can be
...
// SERVERS.md.
//
//   npx vite build --config tools/looks/vite.swirl.config.mjs --outDir <dir>
...
export default defineConfig({
  ...
  build: {
    ...
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-swirl-look'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'sardine-swirl.html') },
  },
});
