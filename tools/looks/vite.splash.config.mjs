// Builds tools/looks/splash-probe.html into a scratch directory so it can be
...
//
//   npx vite build --config tools/looks/vite.splash.config.mjs
...
export default defineConfig({
  ...
  build: {
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-splash-probe'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'splash-probe.html') },
  },
});
