// Builds tools/looks/razor-clams.html into a scratch directory so it can be
...
// SERVERS.md.
//
//   npx vite build --config tools/looks/vite.razor.config.mjs --outDir <dir>
...
export default defineConfig({
  ...
  build: {
    ...
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-razor-look'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'razor-clams.html') },
  },
});
