// Builds tools/looks/menu-screen.html into a scratch directory so it can be
...
//
//   npx vite build --config tools/looks/vite.menu.config.mjs --outDir dist-menu-look
...
export default defineConfig({
  ...
  build: {
    ...
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-menu-look'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'menu-screen.html') },
  },
});
