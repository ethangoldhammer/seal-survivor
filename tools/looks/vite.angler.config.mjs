// Builds tools/looks/angler-takes.html into a scratch directory so it can be served
...
//
//   npx vite build --config tools/looks/vite.angler.config.mjs --outDir <dir>
...
export default defineConfig({
  ...
  build: {
    ...
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-angler-look'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'angler-takes.html') },
  },
});
