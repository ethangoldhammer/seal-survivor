// Builds tools/looks/kill-goo.html into a scratch directory so it can be served
...
export default defineConfig({
  ...
  build: {
    ...
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-goo-look'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'kill-goo.html') },
  },
});
