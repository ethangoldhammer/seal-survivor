// Builds tools/looks/fin-twitch.html into a scratch directory so it can be
...
// SERVERS.md.
//
//   npx vite build --config tools/looks/vite.twitch.config.mjs --outDir <dir>
...
export default defineConfig({
  ...
  build: {
    ...
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-twitch-look'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'fin-twitch.html') },
  },
});
