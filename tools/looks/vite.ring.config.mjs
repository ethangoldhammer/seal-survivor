// Builds tools/looks/organic-ring.html into a scratch directory so it can be served
...
//
//   npx vite build --config tools/looks/vite.goo.config.mjs --outDir <dir>
...
export default defineConfig({
  ...
  build: {
    ...
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-ring-look'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'organic-ring.html') },
  },
});
