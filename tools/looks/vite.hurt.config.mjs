// Builds tools/looks/hurt.html into a scratch directory so it can be served
...
//
//   npx vite build --config tools/looks/vite.hurt.config.mjs
...
export default defineConfig({
  ...
  build: {
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-hurt-look'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'hurt.html') },
  },
});
