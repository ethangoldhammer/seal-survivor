// Builds tools/looks/boss-boom.html into a scratch directory so it can be served
...
//
//   npx vite build --config tools/looks/vite.boom.config.mjs --outDir <dir>
...
export default defineConfig({
  ...
  build: {
    ...
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-boom-look'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'boss-boom.html') },
  },
});
