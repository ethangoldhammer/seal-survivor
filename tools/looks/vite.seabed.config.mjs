// Builds tools/looks/seabed-bed.html into a scratch directory so it can be
...
// SERVERS.md.
//
//   npx vite build --config tools/looks/vite.seabed.config.mjs --outDir <dir>
...
export default defineConfig({
  ...
  build: {
    ...
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-seabed-look'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'seabed-bed.html') },
  },
});
