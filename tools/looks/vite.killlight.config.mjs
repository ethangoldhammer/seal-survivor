// Builds tools/looks/kill-light.html into a scratch directory so it can be served
...
//
//   npx vite build --config tools/looks/vite.killlight.config.mjs --outDir <dir>
...
export default defineConfig({
  ...
  build: {
    ...
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-killlight-look'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'kill-light.html') },
  },
});
