// Builds tools/looks/boss-warm.html into a scratch directory so it can be
...
//
//   npx vite build --config tools/looks/vite.bosswarm.config.mjs --outDir <dir>
...
export default defineConfig({
  ...
  build: {
    ...
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-bosswarm'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'boss-warm.html') },
  },
});
