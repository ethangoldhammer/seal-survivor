// Builds tools/looks/shader-preflight.html into a scratch directory so it can be
...
export default defineConfig({
  ...
  build: {
    ...
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-preflight'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'shader-preflight.html') },
  },
});
