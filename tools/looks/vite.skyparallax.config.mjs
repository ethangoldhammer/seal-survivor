// Builds tools/looks/sky-parallax.html into a scratch directory so it can be
...
// SERVERS.md.
//
//   npx vite build --config tools/looks/vite.skyparallax.config.mjs
...
export default defineConfig({
  ...
  build: {
    ...
    target: 'esnext',
    outDir: resolve(PROJECT, 'dist-skyparallax-look'),
    emptyOutDir: true,
    rollupOptions: { input: resolve(HERE, 'sky-parallax.html') },
  },
});
